...
## Настройка рабочего компьютера дома
...
## Настройка программы для подключения к рабочему компьютеру

1. Скачать архив с программой по [ссылке]().
2. Распаковать скаченный архив.
3. Запустить программу **Удаленная работа**.
4. Ввести числовой идентификатор удалённого рабочего компьютера в разделе **Оператор**.
